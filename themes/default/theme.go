...
func init() {
	...
	plugin.RegisterTheme(plugin.Theme{
		...
		ConfigSchema: []plugin.FieldSchema{
			...
			{Name: "card_opacity", Label: "卡片背景透明度", Type: plugin.FieldNumber, Default: "0.80", Description: "0 到 1；仅调整卡片背景透明度，不改变 MDUI 主题配色", Min: "0", Max: "1", Step: "0.01"},
			{Name: "input_opacity", Label: "输入框背景透明度", Type: plugin.FieldNumber, Default: "0.42", Description: "0 到 1；保留 MDUI 输入框背景色，仅调整透明度", Min: "0", Max: "1", Step: "0.01"},
			{Name: "background_mask_opacity", Label: "背景遮罩透明度", Type: plugin.FieldNumber, Default: "0.46", Description: "0 到 1；控制页面背景上方遮罩层透明度", Min: "0", Max: "1", Step: "0.01"},
